    ...
    <main className="min-h-screen px-6 py-8">
      <nav className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-sm">
          <Link
            href="/login"
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 font-medium shadow-sm transition hover:bg-muted"
          >
            <span className="flex h-6 w-6 items-center justify-center rounded-full border border-border bg-white text-slate-900">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-2 rounded-lg bg-foreground px-4 py-2 font-medium text-background shadow-sm transition hover:opacity-90"
          >
            Criar conta
            <ArrowRight size={16} />
          </Link>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 py-20 lg:grid-cols-[1fr_520px] lg:items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Link
              href="/register"
              className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-3 font-medium text-white shadow-sm transition hover:opacity-90"
            >
              Criar conta
              <ArrowRight size={18} />
            </Link>
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-5 py-3 font-medium shadow-sm transition hover:bg-muted"
            >
              <span className="flex h-7 w-7 items-center justify-center rounded-full border border-border bg-white text-slate-900">
